...
import { releaseIssues, resolveMode } from '../src/lib.mjs';
...
await writeFile(path.join(dist, 'build-info.json'), JSON.stringify({ mode, routes: allPages.map(page => page.path) }, null, 2));
